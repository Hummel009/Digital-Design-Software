...
HD_PWD='D:/Source/Digital-Design-Software/Lab01/Lab0102/Lab0102.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex02.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex02.tcl -notrace

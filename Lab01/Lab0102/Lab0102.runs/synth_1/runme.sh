...
HD_PWD='D:/Source/Digital-Design-Software/Lab01/Lab0102/Lab0102.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex02.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex02.tcl

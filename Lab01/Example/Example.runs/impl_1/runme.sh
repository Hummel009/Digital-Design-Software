...
HD_PWD='D:/Source/Digital-Design-Software/Lab01/Example/Example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex.tcl -notrace

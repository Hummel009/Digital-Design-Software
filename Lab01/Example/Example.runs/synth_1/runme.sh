...
HD_PWD='D:/Source/Digital-Design-Software/Lab01/Example/Example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex.tcl

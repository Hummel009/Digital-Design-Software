...
HD_PWD='D:/Source/Digital-Design-Software/Lab01/Lab0104/Lab0104.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex04.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex04.tcl

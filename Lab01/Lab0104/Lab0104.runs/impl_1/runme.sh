...
HD_PWD='D:/Source/Digital-Design-Software/Lab01/Lab0104/Lab0104.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex04.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex04.tcl -notrace
